...
public class Coin extends GameObject {
    public Coin(Vector2 position, World world, Rectangle rectangle) {
        ...
        body = world.createBody(getDynamicBodyDef(pos.x + TILE_SIZE / 2f + rectangle.getX() - (TILE_SIZE - rectangle.getWidth()) / 2f, pos.y + 1 + TILE_SIZE / 2f + rectangle.getY() - (TILE_SIZE - rectangle.getHeight()) / 2f));
